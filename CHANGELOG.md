...
- Layout CSS can now use contrast-color() to provide a colour contrasting with your
  ChurchSuite default brand colour
...
- Fix order of plan items following change in ChurchSuite API behaviour
- Avoid line breaks in song titles in Song Lyrics layout
- Dependency updates
